...
/**
 * @docsExtends EpoDatepickerBaseComponent
 *
 * @example
 *
 ...
 */
@Component({
    selector: 'e-po-datepicker',
    templateUrl: './e-po-datepicker.component.html',
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => EpoDatepickerComponent),
            multi: true
        },
        {
...
export class EpoDatepickerComponent extends EpoDatepickerBaseComponent implements AfterViewInit, OnDestroy {
    ...
    constructor(private controlPosition: EpoControlPositionService, private renderer: Renderer2, el: ElementRef) {
        super();
        this.el = el;
    }
     ...
     *
     * ```
     * import { EpoDatepickerComponent } from '@po-ui/ng-components';
     *
     * ...
     *
     * @ViewChild(EpoDatepickerComponent, { static: true }) datepicker: EpoDatepickerComponent;
     *
     * focusDatepicker() {
